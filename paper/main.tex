...
\IfFileExists{figures/qualitative_comparison.pdf}{
  \begin{figure*}[t]
    ...
    \caption{Qualitative comparison on held-out reconstruction examples.
    All crops must be generated from the same LR inputs and displayed at the
    same scale.}
...
\begin{itemize}
  ...
  \item Per-image public evaluation outputs: \todo{add}.
