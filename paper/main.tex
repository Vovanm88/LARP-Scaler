...
% These two full-width visual summaries are intentionally non-floating.  They
% occupy dedicated single-column pages, then the body resumes in two columns.
\clearpage
\onecolumn
\begin{center}
\begin{minipage}{0.96\textwidth}
  ...
  \captionof{figure}{\textbf{LARP-Scaler image upscaling.} A real $512\times512$ input
...
\begin{minipage}{0.96\textwidth}
  ...
  \captionof{figure}{\textbf{Image-upscaling examples in valid operating regimes.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{figures/qualitative_comparison.jpg}
