...
archival submission we will add the real qualitative benchmark montage, public
Gradio URL, and arXiv identifier.
...
4KLSDB, Unsplash, DIV8K, fine-t2i, WikiArt-derived art subsets, and three
high-resolution SFW anime sources. Images remain in their source locations; the
...
claim. The public demo URL, qualitative benchmark images, and arXiv identifier
also remain pending.
...
with perceptual metrics, human preference, and release-quality qualitative
comparisons.
