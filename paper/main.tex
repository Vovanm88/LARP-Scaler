...
$4\times$. LPIPS and DISTS results are mixed, and 95\% bootstrap intervals are
wide on the 12-image sets. Disabling the trained adapter branch changes PSNR by
...
metrics do not produce a uniform ranking. The adapter-on ablation measures a
